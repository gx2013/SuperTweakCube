	...
	Ogre::Plane plane(Vector3::UNIT_Y, -10);
		...
		*/
		...
		for(int i=-3;i<55;i++) {
			...
			Ogre::SceneNode* isouth_fence_node = m_pSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(i*3.6,-8,175));
			isouth_fence_node->pitch(Ogre::Radian(Ogre::Math::HALF_PI)); 
			isouth_fence_node->scale(0.5,0.5,2.5);
			isouth_fence_node->attachObject(isouth_fence_ent);

			//North Fence
			Ogre::Entity * inorth_fence_ent = m_pSceneMgr->createEntity("WoodPallet.mesh");
			Ogre::SceneNode* inorth_fence_node = m_pSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(i*3.6,-8,-10));
			inorth_fence_node->pitch(Ogre::Radian(-(Ogre::Math::HALF_PI)));
			inorth_fence_node->scale(0.5,0.5,2.5);
		...
		for(int i=-2;i<56;i++)	{
			...
			Ogre::SceneNode* iwest_fence_node = m_pSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(240,-8,i*3));
			iwest_fence_node->pitch(-(Ogre::Radian(Ogre::Math::HALF_PI)));
			iwest_fence_node->roll(Ogre::Radian(Ogre::Math::HALF_PI)); 
			iwest_fence_node->scale(0.5,0.5,2.5);
			...
			if(i < 25 || i > 29)
			{
				...
				Ogre::SceneNode* ieast_fence_node = m_pSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(-15,-8,i*3));
				ieast_fence_node->pitch(Ogre::Radian(Ogre::Math::HALF_PI));
				ieast_fence_node->roll(Ogre::Radian(Ogre::Math::HALF_PI)); 
				ieast_fence_node->scale(0.5,0.5,2.5);
